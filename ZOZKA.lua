...
io.popen("mkdir ZOZKA_Files")
t = "\27[35m".."\nAll Files Started : \n____________________\n"..'\27[m'
i = 0
for v in io.popen('ls ZOZKA_Files'):lines() do
if v:match(".lua$") then
i = i + 1
...
if hash or Bot(msg) or DevZOZKA(msg) or ZOZKADevSou(msg) then    
return true  
else  
return false  
end  
...
if hash or DevZOZKA(msg) or DevBot(msg) or ZOZKADevSou(msg) then     
return true 
else 
return false 
end 
...
if hash or DevZOZKA(msg) or DevBot(msg) or ZOZKADevSou(msg) or creatorA(msg) then     
return true 
else 
return false 
end 
...
if hash or DevZOZKA(msg) or DevBot(msg) or BasicConstructor(msg) or ZOZKADevSou(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or DevZOZKA(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or ZOZKADevSou(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or DevZOZKA(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or ZOZKADevSou(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or  DevZOZKA(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) or ZOZKADevSou(msg) or creatorA(msg) then             
return true 
else 
return false 
end 
...
if DevZOZKAe(user_id) == true then
var = true
elseif DevZOZKA(user_id) == true then
var = true
elseif ZOZKADevSou(user_id) == true then
var = true
...
if tonumber(user_id) == tonumber(1573309498) then  
var = 'مطور السورس'
elseif DevZOZKAe(user_id) == true then
var = "المطور الاساسي"  
elseif tonumber(user_id) == tonumber(bot_id) then  
var = "البوت"
...
local UserName = (data.username_ or "ZOZKA_SoUrcE")
...
function ZOZKA_Files(msg)
for v in io.popen('ls ZOZKA_Files'):lines() do
if v:match(".lua$") then
plugin = dofile("ZOZKA_Files/"..v)
...
function ZOZKA_Started_Bot(msg,data) -- بداية العمل
if msg then
...
local ZOZKA_Msg = database:sismember(bot_id.."List:Filter:text"..msg.chat_id_,text) 
if ZOZKA_Msg then    
...
if text == ("رفع مطور ثانوي") and tonumber(msg.reply_to_message_id_) ~= 0 and ZOZKADevSou(msg) then
function Function_ZOZKA(extra, result, success)
...
if text and text:match("^رفع مطور ثانوي @(.*)$") and ZOZKADevSou(msg) then
...
if text and text:match("^رفع مطور ثانوي (%d+)$") and ZOZKADevSou(msg) then
...
if text == ("حذف مطور ثانوي") and tonumber(msg.reply_to_message_id_) ~= 0 and ZOZKADevSou(msg) then
function Function_ZOZKA(extra, result, success)
...
if text and text:match("^حذف مطور ثانوي @(.*)$") and ZOZKADevSou(msg) then
...
if text and text:match("^حذف مطور ثانوي (%d+)$") and ZOZKADevSou(msg) then
...
if text == ("الثانويين") and DevZOZKA(msg) then
...
if text == ("مسح الثانويين") and ZOZKADevSou(msg) then
database:del(bot_id.."DEV:Sudo:T")
send(msg.chat_id_, msg.id_, "\n•  تم مسح قائمة المطورين الثانويين  ")
end
if text == ("مسح قائمه العام") and DevZOZKA(msg) then
database:del(bot_id.."GBan:User")
send(msg.chat_id_, msg.id_, "\n• تم مسح قائمه العام")
return false
end
if text == ("مسح المطورين") and DevZOZKA(msg) then
...
if text == ("قائمه العام") and DevZOZKA(msg) then
...
if text == ("المطورين") and DevZOZKA(msg) then
...
if text == ("حظر عام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevZOZKA(msg) then
function Function_ZOZKA(extra, result, success)
...
if text and text:match("^حظر عام @(.*)$")  and DevZOZKA(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevZOZKA(msg) then
...
if text == ("الغاء العام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevZOZKA(msg) then
function Function_ZOZKA(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevZOZKA(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevZOZKA(msg) then
...
if text == ("رفع مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevZOZKA(msg) then
function Function_ZOZKA(extra, result, success)
...
if text and text:match("^رفع مطور @(.*)$") and DevZOZKA(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and DevZOZKA(msg) then
local userid = text:match("^رفع مطور (%d+)$")
database:sadd(bot_id.."Sudo:User", userid)
Reply_Status(msg,userid,"reply","• تم ترقيته مطور في البوت")  
return false 
end
if text == ("حذف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevZOZKA(msg) then
function Function_ZOZKA(extra, result, success)
...
if text and text:match("^حذف مطور @(.*)$") and DevZOZKA(msg) then
...
if text and text:match("^حذف مطور (%d+)$") and DevZOZKA(msg) then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local ZOZKArt = database:get(bot_id.."Comd:New:rt:bot:"..RTPA..msg.chat_id_)
if ZOZKArt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"• العضو > ["..data.first_name_.."](t.me/"..(data.username_ or "ZOZKA_SoUrcE")..")".."\n• تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA) 
database:sadd(bot_id.."Special:User"..msg.chat_id_,result.sender_user_id_)  
elseif ZOZKArt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"• العضو > ["..data.first_name_.."](t.me/"..(data.username_ or "ZOZKA_SoUrcE")..")".."\n• تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)
database:sadd(bot_id.."Mod:User"..msg.chat_id_,result.sender_user_id_)  
elseif ZOZKArt == "مدير" and Constructor(msg) then
send(msg.chat_id_, msg.id_,"• العضو > ["..data.first_name_.."](t.me/"..(data.username_ or "ZOZKA_SoUrcE")..")".."\n• تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)  
database:sadd(bot_id.."Manager"..msg.chat_id_,result.sender_user_id_)  
elseif ZOZKArt == "عضو" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"• العضو > ["..data.first_name_.."](t.me/"..(data.username_ or "ZOZKA_SoUrcE")..")".."\n• تم رفعه "..RTPA.." هنا\n")
end
end,nil)   
end   
...
if result.id_ then
local ZOZKArt = database:get(bot_id.."Comd:New:rt:bot:"..text1[2]..msg.chat_id_)
if ZOZKArt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"• العضو > ["..result.title_.."](t.me/"..(text1[3] or "ZOZKA_SoUrcE")..")".."\n• تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."Special:User"..msg.chat_id_,result.id_)  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n•> العضو > ['..data.first_name_..'](t.me/'..(data.username_ or 'ZOZKA_SoUrcE')..') ~'
...
usertext = '\n• العضو > ['..result.title_..'](t.me/'..(username or 'ZOZKA_SoUrcE')..')'
status  = '\n• تم تقيده لمدة  { '..TextEnd[2]..' '..TextEnd[3]..'}'
...
*•●○●○●○●•ٴ*
𝘊𝘩 - [𝘯𝘪𝘨𝘨𝘢](http://t.me/ZOZKA_SoUrcE)•
]]
send(msg.chat_id_, msg.id_,Text)
...
if text == ("مسح ردود المطور") and DevZOZKA(msg) then 
...
if text == ("ردود المطور") and DevZOZKA(msg) then 
local list = database:smembers(bot_id.."List:Rd:Sudo")
text = "\n• قائمة ردود المطور \n ●○━━━━𝘕𝘎━━━━○●\n"
for k,v in pairs(list) do
...
if text == "اضف رد للكل" and DevZOZKA(msg) then 
send(msg.chat_id_, msg.id_,"•  ارسل الكلمه التري تريد اضافتها")
database:set(bot_id.."Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == "حذف رد للكل" and DevZOZKA(msg) then 
...
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'ZOZKA_SoUrcE')..')'
...
local UserName = (b.username_ or "ZOZKA_SoUrcE")
...
if text == (database:get(bot_id.."Name:Bot") or "زوزكا") and GetSourseMember(msg) then      
Namebot = (database:get(bot_id.."Name:Bot") or "زوزكا")
local namebot = {
'ۿۧهلا ؏ـمࢪي .',
...
if database:get(bot_id.."Status:Bc") and not DevZOZKA(msg) then 
...
لعبة رياضيات >> رياضيات
 ...
 لعبة بات >> بات
•━━━━━━• 
- Ch [𝘕𝘐𝘎𝘎𝘈 - SoUrCe](https://t.me/ZOZKA_SoUrcE)
]]
...
if text == "تنظيف المشتركين" and DevZOZKA(msg) then
...
if text == "تنظيف الكروبات" and DevZOZKA(msg) then
...
if text == ("تحديث السورس") and DevZOZKA(msg) then  
send(msg.chat_id_,msg.id_,'• تم التحديث')
os.execute('rm -rf ZOZKA.lua')
os.execute('rm -rf start.lua')
os.execute('wget https://raw.githubusercontent.com/SourceZOZKA/ZOZKA/main/ZOZKA.lua')
os.execute('wget https://raw.githubusercontent.com/SourceZOZKA/ZOZKA/main/start.lua')
dofile('ZOZKA.lua')  
return false
end
if text == "راسلني" then
...
ge = https.request('https://mode-pro.tk/ageApi/ZOZKAapi.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
send(msg.chat_id_, msg.id_, ag.ok.Rt)
end
if text == 'السيرفر' and DevZOZKA(msg) then 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '•  𝘕𝘐𝘎𝘎𝘈  .',url="t.me/ZOZKA_SoUrcE"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text and text:match("^تعين عدد الاعضاء (%d+)$") and DevZOZKA(msg) then
...
if text == 'جلب نسخه احتياطيه' and DevZOZKA(msg) then
local list = database:smembers(bot_id..'Chek:Groups')  
local memo = database:smembers(bot_id..'UsersBot')  
local t = '{"BOT_ID": '..bot_id..',"GP_BOT":{'  
for k,v in pairs(list) do   
...
if text == 'الملفات' and DevZOZKA(msg) then
t = '• جميع الملفات : \n ●○━━━━𝘕𝘎━━━━○● \n'
i = 0
for v in io.popen('ls ZOZKA_Files'):lines() do
if v:match(".lua$") then
...
if DevZOZKA(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/DEV-NAG/files_ZOZKA/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n• اهلا بك في متجر ملفات زوزكا\n• يوجد في المتجر ملف الردود\n• يتم ادراج الملفات في التحديثات القادمه \n ●○━━━━𝘕𝘎━━━━○● \n"
local TextE = "\n ●○━━━━𝘕𝘎━━━━○● \n• تدل علامة (✔) الملف مفعل\n".."• تدل علامة (✖) الملف معطل\n"
local NumFile = 0
for name,Info in pairs(res.plugins_) do
local Check_File_is_Found = io.open("ZOZKA_Files/"..name,"r")
...
if text and text:match("^(تعطيل ملف) (.*)(.lua)$") and DevZOZKA(msg) then
local name_t = {string.match(text, "^(تعطيل ملف) (.*)(.lua)$")}
local file = name_t[2]..'.lua'
local file_bot = io.open("ZOZKA_Files/"..file,"r")
if file_bot then
io.close(file_bot)
...
local json_file, res = https.request("https://raw.githubusercontent.com/DEV-NAG/files_ZOZKA/main/files_ZOZKA/"..file)
if res == 200 then
os.execute("rm -fr ZOZKA_Files/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('ZOZKA.lua')  
else
...
if text and text:match("^(تفعيل ملف) (.*)(.lua)$") and DevZOZKA(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/DEV-NAG/files_ZOZKA/main/files_ZOZKA/"..file)
if res == 200 then
local chek = io.open("ZOZKA_Files/"..file,'w+')
...
if text == "مسح جميع الملفات" and DevZOZKA(msg) then
os.execute("rm -fr ZOZKA_Files/*")
send(msg.chat_id_,msg.id_,"• تم حذف جميع الملفات")
return false
end
if text == 'نقل الاحصائيات' and DevZOZKA(msg) then
...
if text == 'حذف كليشه المطور' and DevZOZKA(msg) then
database:del(bot_id..'Text_Dev')
send(msg.chat_id_, msg.id_,'•  تم حذف كليشه المطور')
end
if text == 'وضع كليشه المطور' and DevZOZKA(msg) then
...
if text == 'رفع النسخه الاحتياطيه' and DevZOZKA(msg) then   
if tonumber(msg.reply_to_message_id_) > 0 then
function by_reply(extra, result, success)   
...
if text == "تحديث" and DevZOZKA(msg) then
dofile("ZOZKA.lua")  
send(msg.chat_id_, msg.id_, "• تم التحديث")
end
if text == 'السورس' or text == 'سورس' or text == 'ياسورس' or text == 'يا سورس' and GetSourseMember(msg) then       
Text = "[𝘞𝘦𝘭𝘤𝘰𝘮𝘦 𝘵𝘰 𝘕𝘪𝘨𝘨𝘢 𝘚𝘰𝘶𝘳𝘤𝘦](t.me/ZOZKA_SoUrcE)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝘕𝘪𝘨𝘨𝘢 𝘚𝘰𝘶𝘳𝘤𝘦 .',url="https://t.me/ZOZKA_Source/117"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
if text == 'اريد بوت' or text == 'اريد مطور' or text == 'خوش سورس' or text == 'سورس زوزكا' or text == 'اريد بوت تمبلر' or text == 'سورس زوزكا' then
Text = [[
...
Text = [[
اهلا عزيزي
متوفر تنصيب بوتات ع سورس زوزكا
...
if text == '@ZZZZD' or text == '@ZOZKA_SoUrcE' or text == 'مودي البدراني' then
Text = [[
@ZZZZD هذا مطور سورس زوزكا
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
tdcli_function ({ ID = "GetChannelFull", channel_id_ = msg.chat_id_:gsub("-100","")}, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevZOZKA(msg) then
...
if not DevZOZKA(msg) and not database:sismember(bot_id..'BaN:In:User',msg.sender_user_id_) and not database:get(bot_id..'Texting:In:Bv') and not database:get(bot_id.."Filter"..msg.sender_user_id_) then
...
if DevZOZKA(msg) and msg.reply_to_message_id_ ~= 0  then    
...
if text =='تغيير المطور الاساسي •' and ZOZKADevSou(msg) then
send(msg.chat_id_, msg.id_,'• ارسل ايدي المطور الاساسي الجديد')
database:set(bot_id..'Ed:DevBots',true) 
end
if text =='تغيير المطور الاساسي •' and not ZOZKADevSou(msg) then
send(msg.chat_id_, msg.id_,'• تسرسح')
end
if text == ("مسح الثانويين •") and not ZOZKADevSou(msg) then
send(msg.chat_id_, msg.id_,'• تسرسح')
end
if text == ("مسح الثانويين •") and ZOZKADevSou(msg) then
database:del(bot_id.."DEV:Sudo:T")
...
inline = {
{{text = '•  𝘕𝘐𝘎𝘎𝘈  .',url='http://t.me/ZOZKA_SoUrcE'}},
}
...
local Name_Bot = (database:get(bot_id.."Name:Bot") or "زوزكا")
...
------------------------------------------------------------------------
if text then
local ZOZKA_Msg = database:sismember(bot_id.."List:Filter:text"..result.chat_id_,text) 
if ZOZKA_Msg then    
