...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/SourceZOZKA/ZOZKA/main/File_Bot/commands.lua") 
...
function plugin_ZOZKA(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.ZOZKA and msg then
pre_msg = plugin.ZOZKA(msg)
end
end
end
...
os.execute('wget https://raw.githubusercontent.com/ZOZKA-TEAM/ZOZKA/main/ZOZKA.lua')
...
usertext = '\n ꙳.︙ العضو » ['..result.title_..'](t.me/'..(username or 'BBBBRR')..')'
status  = '\n ꙳.︙ تم ترقيته مطور'
...
usertext = '\n ꙳.︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BBBBRR')..')'
status  = '\n ꙳.︙ تم ترقيته مطور'
...
if ZOZKA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ꙳.︙ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'BBBBRR')..') \n ꙳.︙ '..ZOZKA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ꙳.︙ العضو : {["..data.first_name_.."](T.ME/BBBBRR)}\n ꙳.︙ ["..ZOZKA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ꙳.︙ عذرا » {["..data.first_name_.."](T.ME/BBBBRR)}\n ꙳.︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if name_MRmode then 
names_MRmode = database:smembers(bot_id.."ZOZKA:blocname"..msg.chat_id_) or ""
...
if mrmode2.first_name_:match("(.*)"..database:get(bot_id.."ZOZKA:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."ZOZKA:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrmode_nnn = database:get(bot_id.."ZOZKA:nump"..msg.chat_id_) or 5
local mrmode_nnn2 = database:get(bot_id.."ZOZKA:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ꙳.︙ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'BBBBRR')..') \n ꙳.︙ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ꙳.︙ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'BBBBRR')..') \n ꙳.︙ تـم قفـل التاك بالكتم ')
end,nil)   
...
if Devmode(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/SourceZOZKA/ZOZKA/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ꙳.︙ اهلا بك في متجر ملفات كايلي\n ꙳.︙ ملفات السورس ↓\n⋆ ┉  ┉  ┉  ┉ ┉  ┉  ┉  ┉ ⋆\n\n"
local TextE = "\n⋆ ┉  ┉  ┉  ┉ ┉  ┉  ┉  ┉ ⋆\n ꙳.︙ علامة تعني { ✔️ } ملف مفعل\n ꙳.︙ علامة تعني { ✖ } ملف معطل\n ꙳.︙ قناة سورس كايلي ↓\n".." ꙳.︙ [اضغط هنا لدخول](t.me/BBBBRR) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/SourceZOZKA/ZOZKA/main/File_Bot/"..file)
if res == 200 then
...
local UserName = (b.username_ or "ZOZKA-TEAM")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ꙳.︙ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BBBBRR')..')'
status  = '\n ꙳.︙ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ꙳.︙ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ꙳.︙ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BBBBRR')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ꙳.︙ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'BBBBRR')..')'..'\n ꙳.︙ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:ZOZKA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n ꙳.︙ ارسل الكلمه تريد اضافتها')
database:set(bot_id.."botss:ZOZKA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:ZOZKA:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:ZOZKA:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:ZOZKA:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"꙳.︙ تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:ZOZKA:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:ZOZKA:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:ZOZKA:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:ZOZKA:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:ZOZKA:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:ZOZKA:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:ZOZKA:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:ZOZKA:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:ZOZKA:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:ZOZKA:List:Rd:Sudo")
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙏𝙚𝘼𝙢 𝙆𝙮𝙡𝙞𝙚',url="t.me/BBBBRR"}},
}
local msg_id = msg.id_/2097152/0.5
...
database:set(bot_id.."BBBBRR:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'꙳. تم تفعيل الانستا')
database:set(bot_id.."BBBBRR:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."BBBBRR:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."BBBBRR:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"꙳.︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."BBBBRR:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."BBBBRR:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
database:set(bot_id.."botss:ZOZKA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:ZOZKA:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"꙳.︙ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:ZOZKA:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:ZOZKA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:ZOZKA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:ZOZKA:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:ZOZKA:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:ZOZKA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:ZOZKA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:ZOZKA:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:ZOZKA:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:ZOZKA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:ZOZKA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:ZOZKA:Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = database:get(bot_id.."botss:ZOZKA:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:ZOZKA:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:ZOZKA:Add:Rd:Sudo:Text2"..text)   
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'BBBBRR')..')'
local iduser = result.sender_user_id_
...
≪─━─━─𝙆𝙮━─━─≫
 ...
 ꙳. رابط حذف [Snspchat](https://accounts.ZOZKAchat.com/accounts/login?continue=https%3A%2F%2Faccounts.ZOZKAchat.com%2Faccounts%2Fdeleteaccount) ܁
]]
send(msg.chat_id_, msg.id_,t) 
return false
end
