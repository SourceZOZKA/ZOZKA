...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./ZOZKA.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("ZO", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S ZOZKA -X kill
screen -S ZOZKA ./ZOZKA
done
]])  
file:close() 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/ZOZKATEAM/Files_ZOZKA/master/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevZOZKAW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevZOZKAW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevZOZKAW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevZOZKAW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevZOZKAW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevZOZKAW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevZOZKAW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
local UserName = (data.username_ or "ZOZKATEAM")
...
local ZOZKA_Msg = ''  
if msgs < 100 then 
ZOZKA_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
ZOZKA_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
ZOZKA_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
ZOZKA_Msg = 'متفاعل' 
elseif msgs < 1200 then 
ZOZKA_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
ZOZKA_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
ZOZKA_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
ZOZKA_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
ZOZKA_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
ZOZKA_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
ZOZKA_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
ZOZKA_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
ZOZKA_Msg = 'رب التفاعل'  
end 
return ZOZKA_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceZOZKA(msg,data) -- بداية العمل
if msg then
...
SourceZOZKAr = '⌁ 🦇 اهلا عزيزي\n ⌁ 🦇 انا بوت اسمي '..Namebot..'\n ⌁ 🦇 اختصاصي حمايه الكروبات\n ⌁ 🦇 من تكرار والسبام والتوجيه والخ…\n ⌁ 🦇 لتفعيلي اتبع الاخطوات…↓\n ⌁ 🦇 اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع ↺{ منشئ او المشرفين } بتفعيل فقط\n[ ⌁ 🦇 [قناة سورس البوت](http://t.me/ZOZKATEAM)'
end 
send(msg.chat_id_, msg.id_, SourceZOZKAr) 
end
end
database:setex(bot_id..'Start:Time'..msg.sender_user_id_,300,true)
return false
end
if not DevZOZKAW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevZOZKAW(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,ZOZKA_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل ⌁ 🕷️' and DevZOZKAW(msg) then  
...
if text == 'تعطيل التواصل ⌁ 🕷️' and DevZOZKAW(msg) then  
...
if text == 'تفعيل البوت الخدمي ⌁ 🕷️' and DevZOZKAW(msg) then  
...
if text == 'تعطيل البوت الخدمي ⌁ 🕷️' and DevZOZKAW(msg) then  
...
if text == 'ضع كليشه ستارت ⌁ 🕷️' and DevZOZKAW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' ⌁ 🦇 ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت ⌁ 🕷️' and DevZOZKAW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' ⌁ 🦇 تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر ⌁ 🕷️' and DevZOZKAW(msg) then 
...
if text == 'تحديث السورس ⌁ 🕷️' and DevZOZKAW(msg) then 
os.execute('rm -rf ZOZKA.lua')
os.execute('wget https://raw.githubusercontent.com/SourceZOZKA/ZOZKA/master/ZOZKA.lua')
send(msg.chat_id_, msg.id_,' ⌁ 🦇 تم تحديث السورس \n ⌁ 🦇 لديك اخر اصدار لسورس لاريكا\n ⌁ 🦇 الاصدار ↺ { 1.3v}')
dofile('ZOZKA.lua')  
end
if text == 'الاصدار ⌁ 🕷️' and DevZOZKAW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⌁ 🦇 اصدار سورس لاريكا \n ⌁ 🦇 الاصدار ↺{ 1.3v}')
end
if text == 'قناه تحديثات البوت ⌁ 🕷️' and DevZOZKAW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⌁ 🦇 [تحديثات البوت](t.me/ZOZKATEAM) \n ⌁ 🦇 [قناه السورس](t.me/ZOZKATEAM)')
end
if text == "ضع اسم للبوت ⌁ 🕷️" and DevZOZKAW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," ⌁ 🦇 ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات ⌁ 🕷️' and DevZOZKAW(msg) then 
...
if text == 'المشتركين ⌁ 🕷️' and DevZOZKAW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ⌁ 🦇 المشتركين↺{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ⌁ 🕷️' and DevZOZKAW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ⌁ 🦇 الكروبات↺{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ⌁ 🕷️") and DevZOZKAW(msg) then
...
if text == ("قائمه العام ⌁ 🕷️") and DevZOZKAW(msg) then
...
if text == ("قائمه الكتم العام ⌁ 🕷️") and DevZOZKAW(msg) then
...
if text=="اذاعه خاص ⌁ 🕷️" and msg.reply_to_message_id_ == 0 and DevZOZKAW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⌁ 🦇 ارسل الان اذاعتك؟ \n ⌁ 🦇 للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه ⌁ 🕷️" and msg.reply_to_message_id_ == 0 and DevZOZKAW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⌁ 🦇 ارسل الان اذاعتك؟ \n ⌁ 🦇 للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت ⌁ 🕷️" and msg.reply_to_message_id_ == 0 and DevZOZKAW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⌁ 🦇 ارسل الان اذاعتك؟ \n ⌁ 🦇 للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه ⌁ 🕷️" and msg.reply_to_message_id_ == 0  and DevZOZKAW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⌁ 🦇 ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص ⌁ 🕷️" and msg.reply_to_message_id_ == 0  and DevZOZKAW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⌁ 🦇 ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ⌁ 🕷️' and DevZOZKAW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ⌁ 🕷️" and DevZOZKAW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ⌁ 🕷️" and DevZOZKAW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'⌁ 🦇  عدد الكروبات الان ↺ { '..#group..' }'..ZOZKAk..''..ZOZKA..'\n⌁ 🦇  الان عدد الكروبات الحقيقي ↺ { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevZOZKAW(msg) then
...
usertext = '\n ⌁ 🦇 العضو ↺ ['..result.title_..'](t.me/'..(username or 'ZOZKATEAM')..')'
status  = '\n ⌁ 🦇 تم ترقيته مطور'
...
if text and text:match("^رفع مطور (%d+)$") and DevZOZKAW(msg) then
...
usertext = '\n ⌁ 🦇 العضو ↺ ['..data.first_name_..'](t.me/'..(data.username_ or 'ZOZKATEAM')..')'
status  = '\n ⌁ 🦇 تم ترقيته مطور'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevZOZKAW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevZOZKAW(msg) then
...
local ZOZKA1_Msg = database:get(bot_id.."ZOZKA1:Add:Filter:Rp2"..text..msg.chat_id_)   
if ZOZKA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ⌁ 🦇 العضو ↺ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'ZOZKATEAM')..') \n ⌁ 🦇 '..ZOZKA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if ZOZKA_Msg and not Special(msg) then  
local ZOZKA_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if ZOZKA_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ⌁ 🦇 العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ⌁ 🦇 ["..ZOZKA_Msg.."] \n")
else
send(msg.chat_id_,0," ⌁ 🦇 العضو : {["..data.first_name_.."](T.ME/ZOZKATEAM)}\n ⌁ 🦇 ["..ZOZKA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ⌁ 🦇 عذرا ↺ {["..data.first_name_.."](T.ME/ZOZKATEAM)}\n ⌁ 🦇 عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevZOZKAW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevZOZKAW(msg) then
...
if text == 'تحديث السورس' and DevZOZKAW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تغير الاشتراك$") and DevZOZKAW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ⌁ 🦇 حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevZOZKAW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ⌁ 🦇 حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ⌁ 🕷️" and DevZOZKAW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " ⌁ 🦇 تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ⌁ 🕷️$") and DevZOZKAW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ⌁ 🦇 حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ⌁ 🕷️" and DevZOZKAW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ⌁ 🕷️" and DevZOZKAW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " ⌁ 🦇 تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ⌁ 🕷️" and DevZOZKAW(msg) then  
...
database:sadd(bot_id.."ZOZKA:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."ZOZKA:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_ZOZKA = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_ZOZKA then 
names_ZOZKA = database:smembers(bot_id.."ZOZKA:blocname"..msg.chat_id_) or ""
if names_ZOZKA and names_ZOZKA[1] then 
for i=1,#names_ZOZKA do 
if name_ZOZKA:match("(.*)("..names_ZOZKA[i]..")(.*)") then 
...
database:set(bot_id.."ZOZKA:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."ZOZKA:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."ZOZKA:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."ZOZKA:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."ZOZKA:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_ZOZKAa_new(ZOZKA1,ZOZKA2)
if ZOZKA2 and ZOZKA2.first_name_ then 
if ZOZKA2.first_name_:match("(.*)"..database:get(bot_id.."ZOZKA:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."ZOZKA:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local ZOZKA_nnn = database:get(bot_id.."ZOZKA:nump"..msg.chat_id_) or 5
local ZOZKA_nnn2 = database:get(bot_id.."ZOZKA:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(ZOZKA_nnn2) == tonumber(ZOZKA_nnn) or tonumber(ZOZKA_nnn2) > tonumber(ZOZKA_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."ZOZKA:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⌁ 🦇 عزيزي >>["..ZOZKA2.username_.."](https://t.me/"..(ZOZKA2.username_ or "ZOZKATEAM")..")\n⌁ 🦇 عليك وضع التوحيد ⪼ {"..database:get(bot_id.."ZOZKA:teh"..msg.chat_id_).."} بجانب اسمك\n⌁ 🦇 عدد المحاولات المتبقيه {"..(tonumber(ZOZKA_nnn) - tonumber(ZOZKA_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_ZOZKAa_new)
end
end
...
local ZOZKAChengName = database:get(bot_id.."ZOZKA:Cheng:Name"..data.id_)
if not data.first_name_ then 
if ZOZKAChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..ZOZKAChengName..']')
database:del(bot_id.."ZOZKA:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if ZOZKAChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."ZOZKA:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local ZOZKAChengUserName = database:get(bot_id.."ZOZKA:Cheng:UserName"..data.id_)
if not data.username_ then 
if ZOZKAChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..ZOZKAChengUserName..']')
database:del(bot_id.."ZOZKA:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if ZOZKAChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."ZOZKA:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local ZOZKAChengPhoto = database:get(bot_id.."ZOZKA:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if ZOZKAChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."ZOZKA:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if ZOZKAChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
  "صورتك كرنج للنعال",
  "معيدي ولطش بصوره",
...
database:set(bot_id.."ZOZKA:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
if text == 'رفع نسخه الاحتياطيه' and DevZOZKAW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'جلب نسخه الاحتياطيه' and DevZOZKAW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ⌁ 🦇 بواسطه ↺ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'ZOZKATEAM')..') \n ⌁ 🦇 تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ⌁ 🦇 بواسطه ↺ ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'ZOZKATEAM')..') \n ⌁ 🦇 تـم قفـل التاك بالكتم ')
end,nil)   
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevZOZKAW(msg) then    
dofile('ZOZKA.lua')  
send(msg.chat_id_, msg.id_, ' ⌁ 🦇 تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevZOZKAW(msg) then
database:del(bot_id..'GBan:User')
send(msg.chat_id_, msg.id_, '\n ⌁ 🦇 تم مسح قائمه العام')
return false
end
if text == ("قائمه العام") and DevZOZKAW(msg) then
local list = database:smembers(bot_id..'GBan:User')
t = "\n ⌁ 🦇 قائمة المحظورين عام \n  ⌯ 𝐋𝐀𝐑𝐈𝐂𝐀 ✞ 𝐓𝐄𝐀𝐌 ||🦇 ꙰ \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevZOZKAW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevZOZKAW(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevZOZKAW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevZOZKAW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevZOZKAW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevZOZKAW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevZOZKAW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevZOZKAW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevZOZKAW(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevZOZKAW(msg) then
database:del(bot_id..'Sudo:User')
send(msg.chat_id_, msg.id_, "\n ⌁ 🦇 تم مسح قائمة المطورين  ")
end
if text == ("المطورين") and DevZOZKAW(msg) then
local list = database:smembers(bot_id..'Sudo:User')
t = "\n ⌁ 🦇 قائمة مطورين البوت \n  ⌯ 𝐋𝐀𝐑𝐈𝐂𝐀 ✞ 𝐓𝐄𝐀𝐌 ||🦇 ꙰ \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
...
if text == ("رفع مطور") and msg.reply_to_message_id_ and DevZOZKAW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevZOZKAW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "ZOZKATEAM")
...
function Function_ZOZKA(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_ZOZKA, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_ZOZKA, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ⌁ 🦇 لعضو ↺ ['..data.first_name_..'](t.me/'..(data.username_ or 'ZOZKATEAM')..')'
status  = '\n ⌁ 🦇 تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ⌁ 🦇 العضو ↺ '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ⌁ 🦇 العضــو ↺ ['..data.first_name_..'](t.me/'..(data.username_ or 'ZOZKATEAM')..')'
...
send(msg.chat_id_, msg.id_,"⌁ 🕷️ عذرآ الرابط معطل اكتب تفعيل الرابط") 
return false  
end
...
database:set(bot_id.."ZOZKA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."ZOZKA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ⌁ 🦇 ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."ZOZKA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."ZOZKA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."ZOZKA1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."ZOZKA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ⌁ 🦇 تم منع الكلمه مع التحذير")  
database:del(bot_id.."ZOZKA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."ZOZKA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."ZOZKA1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."ZOZKA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ⌁ 🦇 ارسل الكلمه الان")  
database:set(bot_id.."ZOZKA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."ZOZKA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."ZOZKA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."ZOZKA1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."ZOZKA1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."ZOZKA1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."ZOZKA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."ZOZKA1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."ZOZKA1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ⌁ 🦇 قائمة المنع \n  ⌯ 𝐋𝐀𝐑𝐈𝐂𝐀 ✞ 𝐓𝐄𝐀𝐌 ||🦇 ꙰ \n"
for k,v in pairs(list) do  
local ZOZKA_Msg = database:get(bot_id.."ZOZKA1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." ↺ {"..ZOZKA_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevZOZKAW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' ⌁ 🦇 تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevZOZKAW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ⌁ 🦇 العضو ↺ ['..result.title_..'](t.me/'..(text1[3] or 'ZOZKATEAM')..')'..'\n ⌁ 🦇 تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevZOZKAW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevZOZKAW(msg) then  
...
if text == 'تفعيل التواصل' and DevZOZKAW(msg) then  
if database:get(bot_id..'Tuasl:Bots') then
database:del(bot_id..'Tuasl:Bots') 
Text = '\n ⌁ 🦇 تم تفعيل التواصل' 
else
...
if text == 'تعطيل التواصل' and DevZOZKAW(msg) then  
if not database:get(bot_id..'Tuasl:Bots') then
database:set(bot_id..'Tuasl:Bots',true) 
Text = '\n ⌁ 🦇 تم تعطيل التواصل' 
else
...
if text == 'تفعيل البوت الخدمي' and DevZOZKAW(msg) then  
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تعطيل البوت الخدمي' and DevZOZKAW(msg) then  
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'['..ZOZKA_Msg[math.random(#ZOZKA_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevZOZKAW(msg) then 
...
if text == ("مسح ردود المطور") and DevZOZKAW(msg) then 
...
if text == ("ردود المطور") and DevZOZKAW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ⌁ 🦇 قائمة ردود المطور \n  ⌯ 𝐋𝐀𝐑𝐈𝐂𝐀 ✞ 𝐓𝐄𝐀𝐌 ||🦇 ꙰ \n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevZOZKAW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevZOZKAW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تفعيل المغادره' and DevZOZKAW(msg) then   
...
if text == 'تعطيل المغادره' and DevZOZKAW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n⌁ 🦇 العضو ↺ ['..data.first_name_..'](t.me/'..(data.username_ or 'ZOZKA')..') '
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'ZOZKATEAM')..')'
local iduser = result.sender_user_id_
...
" ⌁ 🦇 هنا الكرنج ياب",
" ⌁ 🦇 لح لح بعد لح ",
" ⌁ 🦇 هنا التمبلر تع ابوسك يروح لاريكا 💕🍭 ",
...
if text == "تنظيف المشتركين" and DevZOZKAW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات" and DevZOZKAW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
-- vardump(data) 
ZOZKAdx(msg.chat_id_, msg.id_, ' ⌁ 🦇 ايدي المجموعة ↺ ( '..msg.chat_id_..' )\n ⌁ 🦇 عدد الادمنيه ↺ ( *'..data.administrator_count_..' )*\n ⌁ 🦇 عدد المحظورين ↺ ( *'..data.kicked_count_..' )*\n ⌁ 🦇 عدد الاعضاء ↺ ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevZOZKAW(msg) then
...
if database:get(bot_id..'Lock:Games'..msg.chat_id_) then
ZOZKA = {'22','30','33','60','90','2','5','36','16','88','50','10','19',};
name = ZOZKA[math.random(#ZOZKA)]
...
if database:get(bot_id..'Lock:Games'..msg.chat_id_) then
ZOZKA = {'معلومات','قنوات','مجموعات','كتاب','تفاحه','مختلف','سدني','فلوس','اعلم','ذئب','تمساح','ذكي',};
name = ZOZKA[math.random(#ZOZKA)]
...
ZOZKA = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(ZOZKA)
...
--------------------------------------------------------------------------------------------------------------
SourceZOZKA(data.message_,data)
...
------------------------------------------------------------------------
local ZOZKAAbot = database:get(bot_id.."ZOZKA1:Add:Filter:Rp2"..text..result.chat_id_)   
if ZOZKAAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ⌁ 🦇 العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ⌁ 🦇 ["..ZOZKAAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local ZOZKA1_Msg = database:get(bot_id.."ZOZKA1:Add:Filter:Rp2"..text..result.chat_id_)   
if ZOZKA1_Msg then    
send(msg.chat_id_, msg.id_," ⌁ 🦇 "..ZOZKA1_Msg)
