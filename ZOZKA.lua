...
sendDocument(DevId, 0, 0, 1, nil, './ZOZKA.lua', dl_cb, nil)
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/SourceZOZKA/ZOZKAFiles/master/getfile.json")
if res == 200 then
...
local GetJson, Res = https.request("https://raw.githubusercontent.com/SourceZOZKA/ZOZKAFiles/master/DevProxFiles/"..FileName)
if Res == 200 then
